...
#Start, in order to note time -- the factor that decides the score.
start = time.time()
 
#Defining the room - called scene.
scene = soy.scenes.Room(soy.atoms.Size((15.0, 10.0, 40.0)), 1, 0, 0, 0)
 
#Defining the first level. Note: Current Version contains only 1 level.
def level_1():
    ...
    background = soy.textures.Texture('./Images/scene_bg.jpg')
    scene.material = soy.materials.Textured(colormap = background)
    ...
    scene['object_1_1'].addForce(randint(-750, 750), randint(-750, 750), randint(-750, 750))
    scene['object_1_2'].addForce(randint(-750, 750), randint(-750, 750), randint(-750, 750))
 
    scene['object_2_1'].addForce(randint(-750, 750), randint(-750, 750), randint(-750, 750))
    scene['object_2_2'].addForce(randint(-750, 750), randint(-750, 750), randint(-750, 750))
 
    scene['object_3_1'].addForce(randint(-750, 750), randint(-750, 750), randint(-750, 750))
    scene['object_3_2'].addForce(randint(-750, 750), randint(-750, 750), randint(-750, 750))
 
    scene['object_4'].addForce(randint(-750, 750), randint(-750, 750), randint(-750, 750))
    scene['object_5'].addForce(randint(-750, 750), randint(-750, 750), randint(-750, 750))
...
def menu():
    ...
    sleep(4)
    title3 = soy.textures.Texture('./Images/ins.jpeg')
